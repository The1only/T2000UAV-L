...
static float filteredSpeedValue = 0;
...
void airspeed_loop() {
  ...
  filteredSpeedValue = alpha * dpPa + (1 - alpha) * filteredSpeedValue; 
  // Use filteredValue for further processing
  float correctedPa = filteredSpeedValue - pressureOffsetPa;  // corrected
