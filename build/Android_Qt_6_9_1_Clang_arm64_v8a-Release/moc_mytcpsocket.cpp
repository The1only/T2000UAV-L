...
template <> constexpr inline auto MyTcpSocket::qt_create_metaobjectdata<qt_meta_tag_ZN11MyTcpSocketE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'doIMU'
        QtMocHelpers::SlotData<void(void *, char *, int)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::VoidStar, 7 }, { 0x80000000 | 8, 9 }, { QMetaType::Int, 10 },
        }}),
        // Slot 'doRadar'
        QtMocHelpers::SlotData<void(void *, char *, int)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::VoidStar, 7 }, { 0x80000000 | 8, 9 }, { QMetaType::Int, 10 },
        }}),
        // Slot 'SensorUartSend'
        QtMocHelpers::SlotData<void(uint8_t *, uint32_t)>(12, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->doIMU((*reinterpret_cast< std::add_pointer_t<void*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<char*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        case 4: _t->doRadar((*reinterpret_cast< std::add_pointer_t<void*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<char*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        case 5: _t->SensorUartSend((*reinterpret_cast< std::add_pointer_t<uint8_t*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<uint32_t>>(_a[2]))); break;
        default: ;
        }
    }
