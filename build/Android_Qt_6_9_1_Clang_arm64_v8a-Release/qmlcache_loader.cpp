...
namespace _0x5f__places_map_qml { 
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/places_map.qml"), &QmlCacheGeneratedCode::_0x5f__places_map_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/marker.qml"), &QmlCacheGeneratedCode::_0x5f__marker_qml::unit);
